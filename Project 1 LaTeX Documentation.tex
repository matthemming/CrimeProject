...
Most of the calculations and aggregations for this analysis were performed in Tableau but occasionally it proved much simpler to perform calculations in SQL and import the resulting data to Tableau. The information on the number of house price bins that the LSOAs moved between was one such case:
\begin{lstlisting}
...
The following code was used to determine which LSOAs should be excluded from the analysis based on the outlier formula Limit = 3rd Quartile + 3 x Interquartile Range:
\begin{lstlisting}
